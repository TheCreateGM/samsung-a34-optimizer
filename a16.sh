...
# Samsung Galaxy A16 Minimalist Optimization & Privacy Script
...
echo "======================================================"
echo "=== Samsung Galaxy A16 Minimalist Optimization Script ==="
echo "======================================================"
...
if ! adb devices | grep -q "device$"; then
    ...
    echo "Please connect your Samsung Galaxy A16 and authorize the connection."
    exit 1
fi
...
echo "=========================================================="
echo "Your Samsung Galaxy A16 has been enhanced for:"
